...
def test_list_cars():
    ...
    vehicles = client.get("/connected-vehicle/v2/vehicles", headers=headers)
...
def test_list_car_info():
    headers = {"vcc-api-key": "TEST_NO_OAUTH"}
    vehicle_info = client.get("/connected-vehicle/v2/vehicles/12345678901234567", headers=headers)
...
def test_engine_data():
    headers = {"vcc-api-key": "TEST_NO_OAUTH"}
    engine_data = client.get("/connected-vehicle/v2/vehicles/12345678901234567/engine-status", headers=headers)
...
def test_engine_start():
    ...
    engine_start = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/engine-start", headers=headers, json=body)
...
def test_engine_stop():
    headers = {"vcc-api-key": "TEST_NO_OAUTH","content-type": "application/json"}
    #check this test
    engine_stop = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/engine-stop", headers=headers)
...
def test_climate_start():
    ...
    climate_start = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/climatization-start", headers=headers)
    ...
    engine_stop = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/climatization-start", headers=headers)
    assert engine_stop.status_code == 200
...
def test_climate_stop():
    ...
    climate_stop = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/climatization-stop", headers=headers)
    ...
    engine_stop = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/climatization-stop", headers=headers)
    assert engine_stop.status_code == 200
    assert engine_stop.json()["data"]["invokeStatus"] == "COMPLETED"
...
def test_windows():
    ...
    lock = client.get("/connected-vehicle/v2/vehicles/12345678901234567/windows", headers=headers)
...
def test_doors_and_lock():
    ...
    lock = client.get("/connected-vehicle/v2/vehicles/12345678901234567/doors", headers=headers)
    assert lock.status_code == 200
...
def test_locking():
    ...
    lock = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/lock", headers=headers)
    assert lock.status_code == 200
...
def test_unlocking():
    ...
    lock = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/unlock", headers=headers)
    assert lock.status_code == 200
...
def test_lock_reduced_guard():
    ...
    lock = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/lock-reduced-guard", headers=headers)
    assert lock.status_code == 200
    assert lock.json()["data"]["invokeStatus"] == "COMPLETED"
...
def test_flash():
    ...
    flash = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/flash", headers=headers)
...
def test_horn():
    ...
    horn = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/honk", headers=headers)
...
def test_horn_and_flash():
    ...
    horn_and_flash = client.post("/connected-vehicle/v2/vehicles/12345678901234567/commands/honk-and-flash", headers=headers)
...
def test_statistic():
    ...
    statistic = client.get("/connected-vehicle/v2/vehicles/12345678901234567/statistics", headers=headers)
...
def test_tyres():
    ...
    tyres = client.get("/connected-vehicle/v2/vehicles/12345678901234567/tyres", headers=headers)
...
def test_fuel():
    ...
    fuel = client.get("/connected-vehicle/v2/vehicles/12345678901234567/fuel", headers=headers)
...
def test_odometer():
    headers = {"vcc-api-key": "TEST_NO_OAUTH","content-type": "application/json"}
    odometer = client.get("/connected-vehicle/v2/vehicles/12345678901234567/odometer", headers=headers)
...
def test_engine_diag():
    headers = {"vcc-api-key": "TEST_NO_OAUTH","content-type": "application/json"}
    engine_diag = client.get("/connected-vehicle/v2/vehicles/12345678901234567/engine", headers=headers)
...
def test_diagnostics():
    ...
    # No warning
    diagnostics = client.get("/connected-vehicle/v2/vehicles/12345678901234567/diagnostics", headers=headers)
...
def test_brakes():
    headers = {"vcc-api-key": "TEST_NO_OAUTH","content-type": "application/json"}
    brakes = client.get("/connected-vehicle/v2/vehicles/12345678901234567/brakes", headers=headers)
...
def test_warnings():
    headers = {"vcc-api-key": "TEST_NO_OAUTH","content-type": "application/json"}
    warnings = client.get("/connected-vehicle/v2/vehicles/12345678901234567/warnings", headers=headers)
...
def test_commands():
    ...
    commands = client.get("/connected-vehicle/v2/vehicles/12345678901234567/commands", headers=headers)
    commands_json = commands.json()
    assert commands.status_code == 200

def test_command_accessibility():
    headers = {"vcc-api-key": "TEST_NO_OAUTH","content-type": "application/json"}
    accessibility = client.get("/connected-vehicle/v2/vehicles/12345678901234567/command-accessibility", headers=headers)
