...
database.AdditionalDatabase["TEST_OAUTH"] = database.AdditionalData(client_secret="client_secret", code="code", access_token="access_token", refresh_token="refresh_token",code_challenge_method="plain",code_challenge="code_challenge")
